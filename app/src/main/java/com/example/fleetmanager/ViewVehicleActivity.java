...
public class ViewVehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view__vehicle);
        r = (RecyclerView) findViewById(R.id.recyclerVehicle);
        show();
    }
    ...
    public void show(){
        ...
        JsonObjectRequest jsonreq = new JsonObjectRequest("http://"+Ipaddress.ip+"/fleet/view_vehicle.php", job , new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    ViewVehicleAdapter ad = new ViewVehicleAdapter(jarr , ViewVehicleActivity.this);


                    // setting properties for recycler view like how it scroll vertically , horizontally
                    r.setLayoutManager(new LinearLayoutManager(ViewVehicleActivity.this , LinearLayoutManager.VERTICAL,false));
        ...
        AppControllerActivity app = new AppControllerActivity(ViewVehicleActivity.this);
