...
public class ViewOpenWorkOrderMechanicActivity extends AppCompatActivity {
    RecyclerView r;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mec__open__work);
    ...
    public void show(){
        ...
        JsonObjectRequest jsonreq = new JsonObjectRequest("http://"+ Ipaddress.ip+"/fleet/viewopen_work.php", job , new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    ViewOWrkOrdrMecAdapter ad = new ViewOWrkOrdrMecAdapter(jarr , ViewOpenWorkOrderMechanicActivity.this);


                    // setting properties for recycler view like how it scroll vertically , horizontally
                    r.setLayoutManager(new LinearLayoutManager(ViewOpenWorkOrderMechanicActivity.this , LinearLayoutManager.VERTICAL,false));
        ...
        AppControllerActivity app = new AppControllerActivity(ViewOpenWorkOrderMechanicActivity.this);
